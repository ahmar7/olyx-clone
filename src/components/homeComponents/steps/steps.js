        ...
        >
          ...
          >
            <div className="div-block-8">
              <div className="text-block-9 perk-center">
                ...
                <span className="primary-text">AI</span>
              </div>
            </div>
            <div className="text-block-10 text-center">
              Gain access to trailblazing investment strategies through our
              AI-powered bot. Earn up to 2.2% BUSD per day passively, while
              entitled to claim rewards daily. Welcome to the new era of crypto
              trading and wealth accumulation. Sit back and start earning
              passive income today in one click.
            </div>
          </div>
          <img
            src={V3}
          ...
          <div className="rnd-text">
            ...
            >
              Gain access to trailblazing investment strategies through our
              AI-powered bot. Earn up to 2.2% BUSD per day passively, while
              entitled to claim rewards daily.{" "}
