            ...
            >
              <div className="card-feature-featured-content">
                <h2 className="title card-feature-featured">
                  Your financial freedom starts{" "}
                  <span className="primary-text">today.</span>
                </h2>
                <p className="paragraph cavt card-feature-featured">
                  Gain access to trailblazing investment strategies through our
                  AI-powered bot. Earn up to 2.2% BUSD per day while entitled to
                  claim rewards daily.{" "}
                  <span className="primary-text">
                    Welcome to the new era of trading and wealth accumulation.
                  </span>{" "}
                  Sit back and start earning passive income today in one click.
                  YieldTrust aims to create awareness about AI and crypto by
                  showcasing their enormous potential through our innovations.
                </p>
