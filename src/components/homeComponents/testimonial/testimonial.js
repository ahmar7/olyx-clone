...
"
          >
            As Rome wasn't built in a day, neither YieldTrust will be. Take a
            look at our current developments and stay tuned for what's to come.
          </p>
        </div>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <div
                            className="inprogress-text roadmap-status"
                            aria-hidden="true"
                          >
                            In-Progress
                          </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <p
                          ...
                          aria-hidden="true"
                        >
                          We will market YieldBot for proprietary use through
                          NFTs. First, we will convince the DeFi community of
                          our invention. In due course, everyone will witness
                          YieldBot's consistent yield output and simplistic use.
                          Users may play with the options and specifications of
                          the software and develop their own strategies. Become
                          an early investor in YieldTrust and earn your
                          whitelist spot in the NFT collection. Spots will be
                          limited and dependent on the size of your stake and
                          the time you're invested in our DApp. Take control of
                          your funds and adapt the trading style to your liking
                          to see the power of AI yourself!
                        </p>
                        <br />
                        <p>
                          YieldSwap is a multichain AMM offering every token
                          available in our DApp. By the time it operates, we
                          will have expanded our staking pools and accumulated
                          enough funds in the treasury to support the swap.
                          YieldSwap uses the cutting-edge technology to
                          automatically acquire the best pricing for
                          cryptocurrency swaps on BSC and other networks.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <p
                          ...
                          aria-hidden="true"
                        >
                          We will introduce a utility and governance token in
                          one for YieldTrust. Name, ticker, and other tokenomics
                          will be revealed in a dedicated announcement. The
                          token is necessary as it's supposed to play a crucial
                          role in our upcoming AI-powered hedge fund, where
                          decision-making is driven by a decentralised
                          autonomous organisation (DAO). Besides governance,
                          further benefits of our token include ecosystem
                          discounts, dividend distribution, other types of
                          airdrops, private deals, and bonus daily ROI in our
                          DApp. Users will need to stake our token to gain these
                          privileges, and there will be specific tiers to mark
                          the differences.
                        </p>
                        <br />
                        <p>
                          Furthermore, you will be able to trade with leverage
                          up to 50 times on our platform using YieldTrust
                          Derivatives. For transparency reasons, the initial
                          money to sustain our trading DEX and aspire bigger
                          ambitions outside of our main utility is made possible
                          by our TGE and series funding. The leverage pairs will
                          based on every available token in our DApp.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <p
                          ...
                          aria-hidden="true"
                        >
                          Last but certainly not least, we are setting up an
                          AI-powered hedge fund governed by a decentralised
                          autonomous organisation (DAO) consisting of YieldTrust
                          users with a minimum staked contribution in our native
                          token. Your stake will determine your influence in the
                          DAO, amongst other advantages, whereas the AI members
                          of the fund do the trading strategy selection and
                          profit generation. Investors will be able to purchase
                          shares in the hedge fund and receive dividends when
                          payouts are made.
                        </p>
                        <br />
                        <p>
                          As a staker and a DAO member, you are also entitled to
                          receive a portion of these dividends (corresponding to
                          your importance in the network). The AI members can be
                          seen as "servants" of the fund, and needless to say,
                          it's our most exciting invention of the year. We will
                          ensure the DAO is constantly expanding, more secure,
                          and more stable.
                        </p>
                      </div>
                    </div>
